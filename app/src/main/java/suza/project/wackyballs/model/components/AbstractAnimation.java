...
/**
 * This class extends AbstractFigure and adds animation functionality to it.
 *
 * Created by lmark on 06/08/2017.
 */

public abstract class AbstractAnimation extends AbstractFigure {
    private static final String TAG = AbstractAnimation.class.getSimpleName();
    ...
    public AbstractAnimation(Bitmap animatedBitmap, int x, int y, int fps, int frameCount) {
